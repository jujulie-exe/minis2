...
Camera *CallCammObj(const json &data) {
  ...
  value=0 ♥ ♥ Camera Controls ♥ auto_exposure x009a0901 (menu) : min=0 max=3
  default=3 value=3 (Aperture Priority Mode) ♥ exposure_time_absolute 0x009a0902
  (int) : min=3 max=2047 step=1 default=3 value=156 flags=inactive ♥
